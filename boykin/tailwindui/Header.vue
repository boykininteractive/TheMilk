      ...
      >
        ...
        :::
          ...
          <button
            ...
            @click="mobileMenuOn = !mobileMenuOn"
          >
        ...
        <nav class="hidden md:flex space-x-10">
          <div class="relative">
            ...
            <button
              ...
              @click="solutionsMenuOn = !solutionsMenuOn"
              :class="solutionsMenuOn ? 'text-gray-900' : 'text-gray-500'"
            >
              <span>Solutions</span>
                  ...
                  <div class="z-20 relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                    ...
                    >
                      ...
                      <div class="space-y-1">
                        ...
                        <p
                          class="text-sm leading-5 text-gray-500"
                        >Your customers data will be safe and secure.</p>
                      </div>
                    </a>
                    <a
                      href="#"
          ...
          <div class="relative">
            ...
            <button
              ...
              @click="moreMenuOn = !moreMenuOn"
              :class="moreMenuOn ? 'text-gray-900' : 'text-gray-500'"
            >
              <span>More</span>
              <!-- Item active: "text-gray-600", Item inactive: "text-gray-400" -->
              <svg
                  ...
                  <div class="z-20 relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                    ...
                    >
                      ...
                      <div class="space-y-1">
                        ...
                        <p
                          class="text-sm leading-5 text-gray-500"
                        >Get all of your questions answered in our forums or contact support.</p>
                      </div>
                    </a>
                    <a
                      href="#"
                    ...
                    >
                      ...
                      <div class="space-y-1">
                        ...
                        <p
                          class="text-sm leading-5 text-gray-500"
                        >Learn how to maximize our platform to get the most out of it.</p>
                      </div>
                    </a>
                    <a
                      href="#"
                    ...
                    >
                      ...
                      <div class="space-y-1">
                        ...
                        <p
                          class="text-sm leading-5 text-gray-500"
                        >See what meet-ups and other events we might be planning near you.</p>
                      </div>
                    </a>
                    <a
                      href="#"
                    ...
                    >
                      ...
                      <div class="space-y-1">
                        ...
                        <p
                          class="text-sm leading-5 text-gray-500"
                        >Understand how we take your privacy seriously.</p>
                      </div>
                    </a>
                  </div>
              ...
              <div>
                <nav class="grid row-gap-8">
                  ...
                  >
                    ...
                    <div class="text-base leading-6 font-medium text-gray-900">Solutions</div>
                  </a>
                  <a
                    href="#"
                    class="-m-3 p-3 flex items-center space-x-3 rounded-md hover:bg-gray-50 transition ease-in-out duration-150"
                  >
                    ...
                    <div class="text-base leading-6 font-medium text-gray-900">Pricing</div>
                  </a>
                  <a
                    href="#"
                    class="-m-3 p-3 flex items-center space-x-3 rounded-md hover:bg-gray-50 transition ease-in-out duration-150"
                  >
                    ...
                    <div class="text-base leading-6 font-medium text-gray-900">Docs</div>
                  </a>
                  <a
                    href="#"
                    class="-m-3 p-3 flex items-center space-x-3 rounded-md hover:bg-gray-50 transition ease-in-out duration-150"
                  >
                    ...
                    <div class="text-base leading-6 font-medium text-gray-900">More</div>
                  </a>
                </nav>
              </div>
            </div>
