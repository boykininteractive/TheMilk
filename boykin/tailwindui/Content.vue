<template>
  ...
  <div class="relative py-16 overflow-hidden bg-white">
    <div
      class="px-4 mx-auto antialiased prose prose-lg text-gray-900 sm:prose lg:prose-lg xl:prose-2xl"
    >
      <p class="lead">
      ...
      <figure>
        <img
          data-src="https://images.unsplash.com/photo-1556740758-90de374c12ad?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1000&amp;q=80"
          alt="photo"
          class="lazyload"
        />
        <figcaption>
      ...
      <p>
        ...
        <code>tailwind.config.js</code> file looks like at the time of writing:
      </p>
  ...
  plugins: [],
      ...
      <p>
        ...
        <code>code</code> tag inside of a link, like if I wanted to tell you
        about the
      ...
      <p>
        ...
        <code>h5</code> or <code>h6</code> in your content, Medium only supports
        two heading levels for a reason, you animals. I honestly considered
        using a <code>before</code> pseudo-element to scream at you if you use
        an <code>h5</code> or <code>h6</code>.
      </p>
      <p>
